...
clear;clear;clear
  ...
  # // Banner
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo -e "\033[46m              BAYU VPN STORE \033[0m"
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo ""
sleep 3
clear
...
# USERNAME
rm -f /usr/bin/user
username=$(curl https://raw.githubusercontent.com/BvsshXyz/v4/simontok/izinip | grep $MYIP | awk '{print $2}')
echo "$username" >/usr/bin/user
expx=$(curl https://raw.githubusercontent.com/BvsshXyz/v4/simontok/izinip | grep $MYIP | awk '{print $3}')
echo "$expx" >/usr/bin/e
# DETAIL ORDER
...
Exp1=$(curl https://raw.githubusercontent.com/BvsshXyz/v4/simontok/izinip | grep $MYIP | awk '{print $4}')
if [[ $today < $Exp1 ]]; then
sts="${Info}"
else
sts="${Error}"
...
clear
# REPO    
    REPO="https://raw.githubusercontent.com/BvsshXyz/v4/simontok/"
...
restart_system() {
    USRSC=$(wget -qO- https://raw.githubusercontent.com/BvsshXyz/v4/simontok/izinip | grep $ipsaya | awk '{print $2}')
    EXPSC=$(wget -qO- https://raw.githubusercontent.com/BvsshXyz/v4/simontok/izinip | grep $ipsaya | awk '{print $3}')
...
<code>────────────────────</code>
<code>SCRIPT BY BAYU TUNNELING</code> 
<code>────────────────────</code>
<i>Automatic Notification from Github</i>
"'&reply_markup={"inline_keyboard":[[{"text":"⭐ᴏʀᴅᴇʀ⭐","url":"https://t.me/BayuVpnStore"},{"text":"⭐ɪɴꜱᴛᴀʟʟ⭐","url":"https://wa.me/083824505310"}]]}'
